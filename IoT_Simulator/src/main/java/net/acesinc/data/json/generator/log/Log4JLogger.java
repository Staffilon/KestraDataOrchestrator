...
/**
 * Un Logger Producer invia gli eventi json a un file di registro nella logsdirectory in un file denominato json-data.log. 
 * I registri rotolano in base al tempo e alle dimensioni.
 *
 * @author andrewserff
 */
